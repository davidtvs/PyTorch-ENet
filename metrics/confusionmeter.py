...
class ConfusionMeter():
    ...
    def add(self, predicted, target):
        ...
        Keyword arguments:
        - predicted (Tensor or numpy.ndarray): Can be an N x K tensor of
        predicted scores obtained from the model for N examples and K classes
        or an N-tensor of integer values between 0 and K-1.
        - target (Tensor or numpy.ndarray): Can be a N-tensor of integer values
        assumed to be integer values between 0 and K-1 or N x K tensor, where
