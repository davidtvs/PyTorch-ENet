...
Note: When refering to the number of classes, the void/unlabelled class is excluded.
...
The CamVid dataset supported here is a 12 class version developed by the authors of SegNet. [Download link here](https://github.com/alexgkendall/SegNet-Tutorial/tree/master/CamVid). For actual training, a 11 class version is used - the "road marking" class is combined with the "road" class.
